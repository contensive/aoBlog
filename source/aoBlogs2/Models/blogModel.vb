...
Namespace Models
    Public Class BlogModel
        ...
        '''table definition
        '''</summary>
        Public Shared ReadOnly Property tableMetadata As DbBaseTableMetadataModel = New DbBaseTableMetadataModel("Blogs", "ccBlogs", "default", False)
        '
        '====================================================================================================
        ' -- instance properties
        ...
        Public Shared Function verifyBlog(cp As CPBaseClass, instanceGuid As String) As BlogModel
            Try
                ...
                Dim blogEntry As BlogPostModel = addDefault(Of BlogPostModel)(cp)
                ...
                '
                Dim RSSFeedBlogRules As RSSFeedBlogRuleModel = addDefault(Of RSSFeedBlogRuleModel)(cp)
                ...
                '
                Dim callToAction = create(Of CallsToActionModel)(cp, guidDefaultCallToAction)
                If (callToAction Is Nothing) Then
                    callToAction = DbBaseModel.addDefault(Of CallsToActionModel)(cp)
