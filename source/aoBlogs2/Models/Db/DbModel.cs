...
namespace Contensive.Addons.Blog.Models {
    public abstract class DbModel {
        ...
        /// <param name="cp"></param>
        /// <returns></returns>
        internal static T @add<T>(CPBaseClass cp) where T : DbModel {
            T result = null;
            try {
        ...
        internal static T create<T>(CPBaseClass cp, int recordId) where T : DbModel {
            T result = null;
            try {
                if (recordId > 0) {
                    var instanceType = typeof(T);
        ...
        internal static T create<T>(CPBaseClass cp, string recordGuid) where T : DbModel {
            T result = null;
            try {
                var instanceType = typeof(T);
                string contentName = derivedContentName(instanceType);
        ...
        internal static T createByName<T>(CPBaseClass cp, string recordName) where T : DbModel {
            T result = null;
            try {
        ...
        /// <param name="cp"></param>
        /// <param name="cs"></param>
        private static T loadRecord<T>(CPBaseClass cp, CPCSBaseClass cs, List<string> listOfLowerCaseFields = null) where T : DbModel {
        ...
        /// <param name="cp"></param>
        /// <returns></returns>
        internal int save<T>(CPBaseClass cp) where T : DbModel {
            var cs = cp.CSNew();
            try {
        ...
        internal static void delete<T>(CPBaseClass cp, int recordId) where T : DbModel {
            try {
                if (recordId > 0) {
                    var instanceType = typeof(T);
                    string contentName = derivedContentName(instanceType);
        ...
        internal static void delete<T>(CPBaseClass cp, string ccguid) where T : DbModel {
            try {
                if (!string.IsNullOrEmpty(ccguid)) {
                    var instanceType = typeof(T);
                    string contentName = derivedContentName(instanceType);
        ...
        /// <returns></returns>
        internal static List<T> createList<T>(CPBaseClass cp, string sqlCriteria, string sqlOrderBy, int pageSize = 9999, int pageNumber = 1) where T : DbModel {
        ...
        // 
        internal static List<T> createList<T>(CPBaseClass cp, string sqlCriteria) where T : DbModel {
        ...
        /// <param name="sqlCriteria"></param>
        /// <returns></returns>
        internal static List<T> createList<T>(CPBaseClass cp, string sqlCriteria, string sqlOrderBy, int pageSize, int pageNumber, List<string> listOfLowerCaseFields = null) where T : DbModel {
            var result = new List<T>();
            try {
                var cs = cp.CSNew();
                var ignoreCacheNames = new List<string>();
        ...
        /// <returns></returns>
        internal static string getRecordName<T>(CPBaseClass cp, int recordId) where T : DbModel {
            try {
                if (recordId > 0) {
                    var instanceType = typeof(T);
                    string tableName = derivedContentTableName(instanceType);
        ...
        /// <returns></returns>
        internal static string getRecordName<T>(CPBaseClass cp, string ccGuid) where T : DbModel {
            try {
                if (!string.IsNullOrEmpty(ccGuid)) {
                    var instanceType = typeof(T);
                    string tableName = derivedContentTableName(instanceType);
        ...
        /// <param name="ccGuid"></param>record
        /// <returns></returns>
        internal static int getRecordId<T>(CPBaseClass cp, string ccGuid) where T : DbModel {
            try {
                if (!string.IsNullOrEmpty(ccGuid)) {
                    var instanceType = typeof(T);
                    string tableName = derivedContentTableName(instanceType);
        ...
        // 
        // ====================================================================================================
        internal static int getCount<T>(CPBaseClass cp, string sqlCriteria) where T : DbModel {
            int result = 0;
            try {
                var instanceType = typeof(T);
                string tableName = derivedContentTableName(instanceType);
        ...
        /// <returns></returns>
        internal string getUploadPath<T>(string fieldName) where T : DbModel {
            var instanceType = typeof(T);
            string tableName = derivedContentTableName(instanceType);
