    ...
    Public Class ListView
        ...
        Public Shared Function GetListView(cp As CPBaseClass, app As ApplicationController, request As View.RequestModel) As String
            ...
            Try
                ...
                Dim blogCategory = DbBaseModel.create(Of Models.BlogCategorieModel)(cp, request.categoryId)
                '
                If (blogCategory IsNot Nothing) Then
                    BlogEntryList = DbBaseModel.createList(Of BlogPostModel)(cp, "(BlogID=" & blog.id & ")And(BlogCategoryID=" & request.categoryId & ")", "DateAdded Desc", blog.PostsToDisplay, 1)
                ...
                Else
                    BlogEntryList = DbBaseModel.createList(Of BlogPostModel)(cp, "(BlogID=" & blog.id & ")", "DateAdded Desc", blog.PostsToDisplay, 1)
                ...
                Else
                    Dim blogCategoryList = DbBaseModel.createList(Of BlogCategorieModel)(cp, "")
                ...
                If blog.AllowCategories Then
                    ...
                    ' select a category
                    qs = cp.Doc.RefreshQueryString
                    Dim BlogCategoryList As List(Of BlogCategorieModel) = DbBaseModel.createList(Of BlogCategorieModel)(cp, "")
