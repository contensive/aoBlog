...
// Email Subscribe
//
function blogInitEmailSubscribe() {
...
// Search Form Submit
//
function blogInitSearch() {
	jQuery('#blogSidebarSearch').on('click', function (e) {
		e.preventDefault();
		jQuery('#blogSidebarSearchForm').submit();
	});
}
//
// Initialize all blog handlers
//
function blogInit() {
	blogInitEmailSubscribe();
	blogInitSearch();
}
